...
BEGIN {
    for my $pkg (qw( Google::Ai::Generativelanguage::V1beta::GenerativeService::BatchEmbedContentsResponse Google::Ai::Generativelanguage::V1beta::GenerativeService::BidiGenerateContentServerMessage Google::Ai::Generativelanguage::V1beta::GenerativeService::CountTokensResponse Google::Ai::Generativelanguage::V1beta::GenerativeService::EmbedContentResponse Google::Ai::Generativelanguage::V1beta::GenerativeService::GenerateAnswerResponse Google::Ai::Generativelanguage::V1beta::GenerativeService::GenerateContentResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
package main;
use Google::Ai::Generativelanguage::GenerativeServiceClient;

my $client = Google::Ai::Generativelanguage::GenerativeServiceClient->new( credentials => 'dummy' );
