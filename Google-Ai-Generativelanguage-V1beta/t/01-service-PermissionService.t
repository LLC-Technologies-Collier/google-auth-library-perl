...
BEGIN {
    for my $pkg (qw( Google::Ai::Generativelanguage::V1beta::Permission::Permission Google::Ai::Generativelanguage::V1beta::PermissionService::TransferOwnershipResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Ai::Generativelanguage::PermissionServiceClient->new( credentials => 'dummy' );
