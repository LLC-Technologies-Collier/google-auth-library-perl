package Google::Ai::Generativelanguage::CacheServiceClient;
...
1; # End of Google::Ai::Generativelanguage::CacheServiceClient

__END__

=head1 NAME

Google::Ai::Generativelanguage::CacheServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Ai::Generativelanguage::CacheServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Ai::Generativelanguage::CacheServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Ai::Generativelanguage::CacheServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Ai::Generativelanguage::CacheServiceClient->new(
