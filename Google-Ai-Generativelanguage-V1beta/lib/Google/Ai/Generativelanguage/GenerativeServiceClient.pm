package Google::Ai::Generativelanguage::GenerativeServiceClient;
...
1; # End of Google::Ai::Generativelanguage::GenerativeServiceClient

__END__

=head1 NAME

Google::Ai::Generativelanguage::GenerativeServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Ai::Generativelanguage::GenerativeServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Ai::Generativelanguage::GenerativeServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Ai::Generativelanguage::GenerativeServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Ai::Generativelanguage::GenerativeServiceClient->new(
