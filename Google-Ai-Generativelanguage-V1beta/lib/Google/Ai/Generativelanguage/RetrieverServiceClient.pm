package Google::Ai::Generativelanguage::RetrieverServiceClient;
...
1; # End of Google::Ai::Generativelanguage::RetrieverServiceClient

__END__

=head1 NAME

Google::Ai::Generativelanguage::RetrieverServiceClient - Client library for Google Cloud Services

=head1 SYNOPSIS

    use Google::Ai::Generativelanguage::RetrieverServiceClient;
    use Google::Auth;

    my $auth = Google::Auth->default();

    # 1. High-performance gRPC Transport (Default)
    my $grpc_client = Google::Ai::Generativelanguage::RetrieverServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Ai::Generativelanguage::RetrieverServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Ai::Generativelanguage::RetrieverServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Ai::Generativelanguage::RetrieverServiceClient->new(
